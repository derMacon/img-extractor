...
@common_prefix.route("/curr-nav")
def show_curr_nav():
    return controller.get_nav_stats()


@common_prefix.route("/settings")
def show_settings():
    return controller.get_settings().to_dict()


@common_prefix.route("/set-hotkey-map")
...
@common_prefix.route("/current-page")
def current_page():
